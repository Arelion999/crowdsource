...
YO = re.compile(r'''(?<![а-яё])(?:
    еще|ее|нее
   |\w*йдет(?:е|ся|сь)?|\w*йдем|\w*йдешь|\w*шел|\w*ьет(?:е|ся)?
   ...
   |зелен(?:ый|ая|ое|ые|ого|ому|ым|ом|ых|ыми|ой|ую|о)
   |темн(?:ый|ая|ое|ые|ого|ому|ым|ом|ых|ыми|ой|ую|о)
   |тепл(?:ый|ая|ое|ые|ого|ому|ым|ом|ых|ыми|ой|ую)
   |легк(?:ий|ая|ое|ие|ого|ому|им|ом|их|ими|ой|ую|о|ость\w*)
   |тяжел(?:ый|ая|ое|ые|ого|ому|ым|ом|ых|ыми|ой|ую|о)
