...
| `items_011.csv` | items | 500 | 30,675 | A recipe to make Trailblazer's Draconic Legs. | ✅ | Автозаполнение из словаря + PR #1 — черновик, 422/500 (84%), нужна вычитка |
| `items_012.csv` | items | 500 | 20,463 | Advanced Harvesting Sickle | ✅ | Автозаполнение из словаря + PR #1 — черновик, 461/500 (92%), нужна вычитка |
...
| `items_015.csv` | items | 500 | 13,707 | Assassin's Rascal Mask | ✅ | Автозаполнение из словаря + PR #1 — черновик, 369/500 (74%), нужна вычитка |
| `items_016.csv` | items | 499 | 11,061 | Aureate Warhammer of Water | ✅ | Автозаполнение из словаря + PR #1 — черновик, 468/499 (94%), нужна вычитка |
| `items_017.csv` | items | 500 | 14,656 | Barrel of Jahin White | ✅ | Автозаполнение из словаря + PR #1 — черновик, 219/500 (44%), нужна вычитка |
...
| `items_020.csv` | items | 500 | 11,726 | Bladed Coat Box | ✅ | Автозаполнение из словаря + PR #1 — черновик, 477/500 (95%), нужна вычитка |
| `items_021.csv` | items | 500 | 13,434 | Boundary Marker for the Desolation | ✅ | Автозаполнение из словаря + PR #1 — черновик, 434/500 (87%), нужна вычитка |
| `items_022.csv` | items | 500 | 12,586 | Branded Residue | ✅ | Автозаполнение из словаря + PR #1 — черновик, 361/500 (72%), нужна вычитка |
| `items_023.csv` | items | 500 | 20,421 | Caldera Skyscale Skin | ✅ | Автозаполнение из словаря + PR #1 — черновик, 471/500 (94%), нужна вычитка |
| `items_024.csv` | items | 500 | 14,148 | Carrion Destroyer Pistol | ✅ | Автозаполнение из словаря — черновик, нужна вычитка |
| `items_025.csv` | items | 500 | 15,045 | Carrion Prowler Pants | ✅ | Автозаполнение из словаря + PR #1 — черновик, 488/500 (98%), нужна вычитка |
| `items_026.csv` | items | 500 | 14,761 | Cavalier's Amulet | ✅ | Автозаполнение из словаря + PR #1 — черновик, 258/500 (52%), нужна вычитка |
| `items_027.csv` | items | 500 | 12,506 | Ceremonial Stave of Rage | ✅ | Автозаполнение из словаря + PR #1 — черновик, 479/500 (96%), нужна вычитка |
...
| `items_030.csv` | items | 500 | 38,487 | Cleric's Soft Wood Warhorn of Air | ✅ | Автозаполнение из словаря + PR #1 — черновик, 297/500 (59%), нужна вычитка |
| `items_031.csv` | items | 500 | 34,799 | Commander's Tormented Rifle of Force | ✅ | Автозаполнение из словаря + PR #1 — черновик, 456/500 (91%), нужна вычитка |
| `items_032.csv` | items | 500 | 27,671 | Contains Mist Shard shoulders recipes and a c | ✅ | Автозаполнение из словаря + PR #1 — черновик, 417/500 (83%), нужна вычитка |
| `items_033.csv` | items | 500 | 11,689 | Crimson Lion Torch Skin | ✅ | Автозаполнение из словаря + PR #1 — черновик, 365/500 (73%), нужна вычитка |
| `items_034.csv` | items | 500 | 15,917 | Deathcamas of Dreams | ✅ | Автозаполнение из словаря + PR #1 — черновик, 459/500 (92%), нужна вычитка |
...
| `items_036.csv` | items | 500 | 13,697 | Dire Orrian Longsword of Blood | ✅ | Автозаполнение из словаря + PR #1 — черновик, 400/500 (80%), нужна вычитка |
| `items_037.csv` | items | 500 | 42,392 | Dolyaks gain increased health and toughness. | ✅ | Автозаполнение из словаря + PR #1 — черновик, 463/500 (93%), нужна вычитка |
| `items_038.csv` | items | 500 | 44,460 | Double-click to choose an ascended armor piec | ✅ | Автозаполнение из словаря + PR #1 — черновик, 445/500 (89%), нужна вычитка |
| `items_039.csv` | items | 500 | 39,041 | Double-click to learn a Jade Punk pistol reci | ✅ | Автозаполнение из словаря + PR #1 — черновик, 365/500 (73%), нужна вычитка |
| `items_040.csv` | items | 500 | 56,105 | Double-click to open. Choose a song from the  | ✅ | Автозаполнение из словаря + PR #1 — черновик, 472/500 (94%), нужна вычитка |
| `items_041.csv` | items | 500 | 26,810 | Double-click to teleport to the Chalon Docks  | ✅ | Автозаполнение из словаря + PR #1 — черновик, 436/500 (87%), нужна вычитка |
| `items_042.csv` | items | 499 | 13,830 | Dragonsblood Spear Reforged | ✅ | Автозаполнение из словаря + PR #1 — черновик, 469/499 (94%), нужна вычитка |
| `items_043.csv` | items | 499 | 11,696 | Ebony Orichalcum Amulet | ✅ | Автозаполнение из словаря + PR #1 — черновик, 472/499 (95%), нужна вычитка |
| `items_044.csv` | items | 499 | 12,598 | Endless Awakened Archer Tonic | ✅ | Автозаполнение из словаря — черновик, 487/499 (98%), нужна вычитка |
| `items_045.csv` | items | 499 | 12,711 | Exalted Supporter: Tier 2 | ✅ | Автозаполнение из словаря + PR #1 — черновик, 438/499 (88%), нужна вычитка |
| `items_046.csv` | items | 499 | 11,168 | Festive Bag of Materials | ✅ | Автозаполнение из словаря + PR #1 — черновик, 344/499 (69%), нужна вычитка |
| `items_047.csv` | items | 499 | 16,026 | Focusing Prism | ✅ | Автозаполнение из словаря + PR #1 — черновик, 427/499 (86%), нужна вычитка |
| `items_048.csv` | items | 498 | 13,018 | Fractal State | ✅ | Автозаполнение из словаря + PR #1 — черновик, 434/498 (87%), нужна вычитка |
| `items_049.csv` | items | 500 | 10,683 | Ghiwane's Music Box (Tradable) | ✅ | Автозаполнение из словаря + PR #1 — черновик, 348/500 (70%), нужна вычитка |
| `items_050.csv` | items | 500 | 10,852 | Giver's Pearl Crusher | ✅ | Автозаполнение из словаря — черновик, 420/500 (84%), нужна вычитка |
| `items_051.csv` | items | 498 | 28,147 | Golden Axe | ✅ | Автозаполнение из словаря + PR #1 — черновик, 431/498 (87%), нужна вычитка |
| `items_052.csv` | items | 499 | 13,093 | Greenflin Seraph Leather Leggings | ✅ | Автозаполнение из словаря + PR #1 — черновик, 443/499 (89%), нужна вычитка |
| `items_053.csv` | items | 500 | 15,127 | Harathi Short Bow | ✅ | Автозаполнение из словаря + PR #1 — черновик, 424/500 (85%), нужна вычитка |
| `items_054.csv` | items | 500 | 11,629 | Heart of an Ember | ✅ | Автозаполнение из словаря + PR #1 — черновик, 485/500 (97%), нужна вычитка |
| `items_055.csv` | items | 500 | 14,807 | Hidden Stash | ✅ | Автозаполнение из словаря + PR #1 — черновик, 471/500 (94%), нужна вычитка |
| `items_056.csv` | items | 500 | 12,605 | Honed Privateer Coat of Scavenging | ✅ | Автозаполнение из словаря + PR #1 — черновик, 334/500 (67%), нужна вычитка |
| `items_057.csv` | items | 498 | 24,252 | Hunter's Wood Stool | ✅ | Автозаполнение из словаря + PR #1 — черновик, 464/498 (93%), нужна вычитка |
| `items_058.csv` | items | 499 | 13,953 | Increases the rate at which customers enter y | ✅ | Автозаполнение из словаря + PR #1 — черновик, 407/499 (82%), нужна вычитка |
| `items_059.csv` | items | 499 | 13,834 | Island Shrub | ✅ | Автозаполнение из словаря + PR #1 — черновик, 458/499 (92%), нужна вычитка |
...
| `items_063.csv` | items | 499 | 11,803 | Lingering Adept Helm | ✅ | Автозаполнение из словаря + PR #1 — черновик, 444/499 (89%), нужна вычитка |
| `items_064.csv` | items | 499 | 11,839 | Mace Token | ✅ | Автозаполнение из словаря + PR #1 — черновик, 124/499 (25%), нужна вычитка |
| `items_065.csv` | items | 500 | 11,635 | Maguuma Jack | ✅ | Автозаполнение из словаря + PR #1 — черновик, 213/500 (43%), нужна вычитка |
| `items_066.csv` | items | 498 | 17,464 | Malign Processional Flame | ✅ | Автозаполнение из словаря + PR #1 — черновик, 232/498 (47%), нужна вычитка |
| `items_067.csv` | items | 500 | 14,706 | Meal Feast: Double-click to set out a Feast o | ✅ | Автозаполнение из словаря + PR #1 — черновик, 427/500 (85%), нужна вычитка |
| `items_068.csv` | items | 378 | 9,004 | Mighty Bronze Axe | ✅ | Автозаполнение из словаря + PR #1 — черновик, 375/378 (99%), нужна вычитка |
| `items_069.csv` | items | 380 | 9,956 | Mini Eelob Poisonfang | ✅ | Автозаполнение из словаря — черновик, 370/380 (97%), нужна вычитка |
| `items_070.csv` | items | 448 | 10,025 | Mini SERV Golem | ✅ | Автозаполнение из словаря + PR #1 — черновик, 401/448 (90%), нужна вычитка |
| `items_071.csv` | items | 499 | 10,669 | Mist Lord's Shield | ✅ | Автозаполнение из словаря + PR #1 — черновик, 475/499 (95%), нужна вычитка |
| `items_072.csv` | items | 500 | 10,740 | Morning Sea Dye | ✅ | Автозаполнение из словаря + PR #1 — черновик, 387/500 (77%), нужна вычитка |
| `items_073.csv` | items | 500 | 13,135 | Night Shade Dye | ✅ | Автозаполнение из словаря + PR #1 — черновик, 445/500 (89%), нужна вычитка |
| `items_074.csv` | items | 500 | 12,976 | Oiled Hardened Shoulderguard Padding | ✅ | Автозаполнение из словаря + PR #1 — черновик, 426/500 (85%), нужна вычитка |
| `items_075.csv` | items | 500 | 10,576 | Orrian Focus of Air | ✅ | Автозаполнение из словаря + PR #1 — черновик, 242/500 (48%), нужна вычитка |
| `items_076.csv` | items | 499 | 14,666 | Pastel Purple Dye | ✅ | Автозаполнение из словаря + PR #1 — черновик, 495/499 (99%), нужна вычитка |
| `items_077.csv` | items | 500 | 14,167 | Permanent Great Jungle Wurm Finisher | ✅ | Автозаполнение из словаря + PR #1 — черновик, 445/500 (89%), нужна вычитка |
...
| `items_079.csv` | items | 500 | 17,089 | Precise Bronze Shield | ✅ | Автозаполнение из словаря + PR #1 — черновик, 472/500 (94%), нужна вычитка |
...
| `items_094.csv` | items | 500 | 14,009 | Reflective Koi Short Bow Skin | ✅ | Автозаполнение из словаря + PR #1 — черновик, 466/500 (93%), нужна вычитка |
| `items_095.csv` | items | 500 | 13,310 | Resilient Krytan Rifle | ✅ | Автозаполнение из словаря + PR #1 — черновик, 447/500 (89%), нужна вычитка |
| `items_096.csv` | items | 500 | 11,985 | Royal Flame Greatsword | ✅ | Автозаполнение из словаря + PR #1 — черновик, 463/500 (93%), нужна вычитка |
| `items_097.csv` | items | 500 | 13,126 | Salvaged from the Perfected Short Bow. Used t | ✅ | Автозаполнение из словаря + PR #1 — черновик, 425/500 (85%), нужна вычитка |
| `items_098.csv` | items | 500 | 13,046 | Scroll of Passage | ✅ | Автозаполнение из словаря + PR #1 — черновик, 226/500 (45%), нужна вычитка |
...
| `items_101.csv` | items | 500 | 11,223 | Shards of Glory Converter | ✅ | Автозаполнение из словаря + PR #1 — черновик, 380/500 (76%), нужна вычитка |
| `items_102.csv` | items | 500 | 13,274 | Silver Shatterer Trophy | ✅ | Автозаполнение из словаря — черновик, 472/500 (94%), нужна вычитка |
| `items_103.csv` | items | 500 | 15,103 | Snack Feast: Double-click to set out a Feast  | ✅ | Автозаполнение из словаря + PR #1 — черновик, 203/500 (41%), нужна вычитка |
| `items_104.csv` | items | 500 | 19,536 | Soldier's Reinforced Scale Gauntlets | ✅ | Автозаполнение из словаря + PR #1 — черновик, 298/500 (60%), нужна вычитка |
...
| `items_109.csv` | items | 500 | 13,584 | Superior Sigil of Blight | ✅ | Автозаполнение из словаря + PR #1 — черновик, 387/500 (77%), нужна вычитка |
| `items_110.csv` | items | 499 | 18,703 | Tamini Sword | ✅ | Автозаполнение из словаря + PR #1 — черновик, 392/499 (79%), нужна вычитка |
| `items_111.csv` | items | 500 | 44,577 | The Predator Vol. 3 | ✅ | Автозаполнение из словаря + PR #1 — черновик, 434/500 (87%), нужна вычитка |
| `items_112.csv` | items | 500 | 16,049 | This short bow will not display an emblem if  | ✅ | Автозаполнение из словаря + PR #1 — черновик, 447/500 (89%), нужна вычитка |
| `items_113.csv` | items | 500 | 13,310 | Tormented Aurillium | ✅ | Автозаполнение из словаря + PR #1 — черновик, 421/500 (84%), нужна вычитка |
| `items_114.csv` | items | 500 | 14,360 | Track 6: Roar of the Delta | ✅ | Автозаполнение из словаря — черновик, 395/500 (79%), нужна вычитка |
| `items_115.csv` | items | 500 | 20,841 | Trusty Blade | ✅ | Автозаполнение из словаря + PR #1 — черновик, 495/500 (99%), нужна вычитка |
| `items_116.csv` | items | 499 | 42,540 | Unlocks the Winter's Presence collection. | ✅ | Автозаполнение из словаря + PR #1 — черновик, 486/499 (97%), нужна вычитка |
| `items_117.csv` | items | 500 | 31,306 | Used to chop down all saplings. Grants a 33%% | ✅ | Автозаполнение из словаря + PR #1 — черновик, 483/500 (97%), нужна вычитка |
...
| `items_120.csv` | items | 500 | 12,887 | Vigorous Steel Shield | ✅ | Автозаполнение из словаря + PR #1 — черновик, 338/500 (68%), нужна вычитка |
| `items_121.csv` | items | 500 | 12,777 | Wanderer's Leystone Vambraces | ✅ | Автозаполнение из словаря + PR #1 — черновик, 446/500 (89%), нужна вычитка |
| `items_122.csv` | items | 500 | 10,236 | White Bass | ✅ | Автозаполнение из словаря + PR #1 — черновик, 471/500 (94%), нужна вычитка |
| `items_123.csv` | items | 500 | 12,285 | Wurm's Gilded Blessing Enrichment | ✅ | Автозаполнение из словаря + PR #1 — черновик, 418/500 (84%), нужна вычитка |
...
| `ui_020.csv` | ui | 492 | 51,871 | <c=@abilitytype>Chain.</c> Slash your foe, th | ✅ | Магистр Клод, Приорат Дурманд + автозаполнение PR #1 (1 строк), нужна вычитка |
| `ui_021.csv` | ui | 499 | 46,099 | <c=@flavor>"Minds, Words, Deeds."<br>—Ash Leg | ✅ | Магистр Клод, Приорат Дурманд + автозаполнение PR #1 (1 строк), нужна вычитка |
...
| `ui_023.csv` | ui | 491 | 49,386 | [lbracket]Lured[rbracket] | ✅ | Магистр Клод, Приорат Дурманд + автозаполнение PR #1 (1 строк), нужна вычитка |
...
| `ui_055.csv` | ui | 497 | 30,251 | Dive deep where Dwayna meets the waterway. | ✅ | Магистр Клод, Приорат Дурманд + автозаполнение PR #1 (1 строк), нужна вычитка |
...
| `ui_070.csv` | ui | 499 | 31,686 | FXVille, Inc. | ✅ | Магистр Клод, Приорат Дурманд + автозаполнение PR #1 (6 строк), нужна вычитка |
...
| `ui_111.csv` | ui | 498 | 29,203 | Private Property of P.I. Joko | ✅ | Магистр Клод, Приорат Дурманд + автозаполнение PR #1 (1 строк), нужна вычитка |
...
| `new_011.csv` | new | 500 | 21,751 | Deputy Styne | ✅ | Магистр Клод, Приорат Дурманд + автозаполнение PR #1 (2 строк), нужна вычитка |
...
| `new_082.csv` | new | 500 | 18,187 | Optionen | ✅ | Автозаполнение из словаря + PR #1 — черновик, 30/500 (6%), нужна вычитка |
...
| `new_086.csv` | new | 500 | 18,287 | Reactor AI |  | Автозаполнение PR #1 — черновик, 5/500 (1%), нужна вычитка |
...
| `new_089.csv` | new | 500 | 13,905 | Retrospektives Runterspringen | ✅ | Автозаполнение из словаря + PR #1 — черновик, 15/500 (3%), нужна вычитка |
...
| `new_091.csv` | new | 500 | 14,438 | Sasha | ✅ | Автозаполнение из словаря + PR #1 — черновик, 17/500 (3%), нужна вычитка |
