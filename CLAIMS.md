...
Всего батчей: **996** | строк: **472,033** | заполнено: **456,158** (96.6%), пусто **15,875** | вычитано человеком: **93,404** (19.8%).
...
| `ui_119.csv` | ui | 500 | 15,708 | Recipe[s]: Raven Totem | ✅ | Arelion999 — вычитан: 180 склеек «Рецепт[|а|ов]» раскрыты полными формами по README, четыре коллизии типов вещей разведены по items_013/014/018, подменённый перевод Recycler исправлен (182 строк) |
