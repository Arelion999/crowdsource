...
Всего батчей: **996** | строк: **472,033** | заполнено: **456,151** (96.6%), пусто **15,882** | вычитано человеком: **87,915** (18.6%).
...
| `ach_010.csv` | ach | 500 | 15,008 | Daily Maguuma Jungle Lumberer | ✅ | Arelion999 — вычитан: рамки ежедневок к канону (прыжковая головоломка, мини-подземелье, реагирование на драконов, завершение событий), топонимы подставлены из слоя, три формы при счётчике (122 строки) |
...
| `ach_013.csv` | ach | 500 | 24,110 | Do not trigger any Gravitational Waves during | ✅ | Arelion999 — вычитан: имена и топонимы из слоя с падежом по контексту, три формы при счётчике, прямые кавычки к ёлочкам, 4 пустые ячейки заполнены (134 строк) |
