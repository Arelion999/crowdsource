...
| `ui_116.csv` | ui | 496 | 16,121 | Recipe[s]: Chiaroscuro Hammers | ✅ | Arelion999 — вычитан: 202 склейки раскрыты, регистр после двоеточия к канону new_023, прямые кавычки к ёлочкам, коллизия Pauldrons/Shoulderguard разведена (349 строк) Второй проход: named-серии и типы вещей к items_004//v2/items, Хорбен/Углегорн/Черногрив, гравировка/инсигния (120 строк) |
| `ui_117.csv` | ui | 500 | 15,889 | Recipe[s]: Gift of Music | ✅ | Arelion999 — вычитан: 200 склеек раскрыты, регистр после двоеточия к канону new_023 (строчная), коллизии типов вещей разведены (335 строк) Второй проход: named-серии к items_004, Леволап/Гризлмут/мастер горна (115 строк) |
| `ui_118.csv` | ui | 499 | 15,713 | Recipe[s]: Lightborne Shield | ✅ | Arelion999 — вычитан: 189 склеек раскрыты, регистр после двоеточия к канону new_023, Lightborne → «светорождённый» по ui_008, девять коллизий типов вещей разведены (395 строк) Второй проход: named-серии к items_004, Надижа (жен.), Феррат, сломанные группы форм (172 строки) |
| `ui_119.csv` | ui | 500 | 15,708 | Recipe[s]: Raven Totem | ✅ | Arelion999 — вычитан: 180 склеек «Рецепт[|а|ов]» раскрыты полными формами по README, четыре коллизии типов вещей разведены по items_013/014/018, подменённый перевод Recycler исправлен, регистр после двоеточия доведён до канона new_023 (182 строк) Второй проход: named-серии к items_004, Seraph Pearl порядок слов, группы форм (161 строка) |
| `ui_120.csv` | ui | 498 | 14,708 | Recipe[s]: Stormcaller Greatsword | ✅ | Arelion999 — вычитан: 246 склеек раскрыты, регистр после двоеточия к канону new_023, Stormcaller → «Зов бури» и Greatsword → «двуручный меч» по items_006/013, четыре коллизии типов вещей разведены (371 строк) Второй проход: named-серии к items_004, Суун (жен., несклон.), Сваард, Теодосий (184 строки) |
