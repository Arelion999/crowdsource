...
Всего батчей: **940** | строк: **450,522** | заполнено: **450,297** (100.0%), пусто **225** | вычитано человеком: **69,344** (15.4%).
...
| `items_081.csv` | items | 500 | 15,540 | Rabid Winged Pants of the Necromancer | ✅ | Arelion999 — стат Rampager's сведён (307 строк); 97 строк с названиями сетов в кавычках ещё нет |
