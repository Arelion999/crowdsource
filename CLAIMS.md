...
| `ach_010.csv` | ach | 500 | 15,008 | Daily Maguuma Jungle Lumberer | ✅ | Arelion999 — вычитан: рамки ежедневок к канону (прыжковая головоломка, мини-подземелье, реагирование на драконов, завершение событий), топонимы подставлены из слоя, три формы при счётчике (118 строк) |
