...
| `items_016.csv` | items | 499 | 11,061 | Aureate Warhammer of Water |  |  |
...
| `items_042.csv` | items | 499 | 13,830 | Dragonsblood Spear Reforged |  |  |
| `items_043.csv` | items | 499 | 11,696 | Ebony Orichalcum Amulet |  |  |
| `items_044.csv` | items | 499 | 12,598 | Endless Awakened Archer Tonic |  |  |
| `items_045.csv` | items | 499 | 12,711 | Exalted Supporter: Tier 2 |  |  |
| `items_046.csv` | items | 499 | 11,168 | Festive Bag of Materials |  |  |
| `items_047.csv` | items | 499 | 16,026 | Focusing Prism |  |  |
| `items_048.csv` | items | 498 | 13,018 | Fractal State |  |  |
| `items_049.csv` | items | 500 | 10,683 | Ghiwane's Music Box (Tradable) |  |  |
| `items_050.csv` | items | 500 | 10,852 | Giver's Pearl Crusher |  |  |
| `items_051.csv` | items | 498 | 28,147 | Golden Axe |  |  |
| `items_052.csv` | items | 499 | 13,093 | Greenflin Seraph Leather Leggings |  |  |
...
| `items_057.csv` | items | 498 | 24,252 | Hunter's Wood Stool |  |  |
| `items_058.csv` | items | 499 | 13,953 | Increases the rate at which customers enter y |  |  |
| `items_059.csv` | items | 499 | 13,834 | Island Shrub |  |  |
| `items_060.csv` | items | 499 | 11,496 | Keeper's Blade |  |  |
| `items_061.csv` | items | 500 | 10,846 | Kodan Scepter Skin |  |  |
| `items_062.csv` | items | 499 | 11,075 | Leafy Sea Dragon |  |  |
| `items_063.csv` | items | 499 | 11,803 | Lingering Adept Helm |  |  |
| `items_064.csv` | items | 499 | 11,839 | Mace Token |  |  |
| `items_065.csv` | items | 500 | 11,635 | Maguuma Jack |  |  |
| `items_066.csv` | items | 498 | 17,464 | Malign Processional Flame |  |  |
| `items_067.csv` | items | 500 | 14,706 | Meal Feast: Double-click to set out a Feast o |  |  |
| `items_068.csv` | items | 378 | 9,004 | Mighty Bronze Axe |  |  |
| `items_069.csv` | items | 380 | 9,956 | Mini Eelob Poisonfang |  |  |
| `items_070.csv` | items | 448 | 10,025 | Mini SERV Golem |  |  |
| `items_071.csv` | items | 499 | 10,669 | Mist Lord's Shield |  |  |
...
| `items_076.csv` | items | 499 | 14,666 | Pastel Purple Dye |  |  |
...
| `items_110.csv` | items | 499 | 18,703 | Tamini Sword |  |  |
...
| `items_116.csv` | items | 499 | 42,540 | Unlocks the Winter's Presence collection. |  |  |
...
| `skins_008.csv` | skins | 499 | 9,085 | Soo-Won's Gaze |  |  |
| `skins_009.csv` | skins | 296 | 5,596 | Villainous Cape |  |  |
| `guild_001.csv` | guild | 497 | 25,200 | A magnificent depiction of the Spirit of Rave |  |  |
...
| `ui_034.csv` | ui | 499 | 13,931 | Bleeds • Swiftness |  |  |
...
| `ui_088.csv` | ui | 498 | 20,659 | Launch a cluster of rusty shrapnel that that  |  |  |
| `ui_089.csv` | ui | 500 | 16,018 | Lesser Air Elemental: Deals damage and grants |  |  |
| `ui_090.csv` | ui | 499 | 24,190 | Linen Coat Panel[s] |  |  |
| `ui_091.csv` | ui | 500 | 19,387 | Loot packets of frostbitten suet from creatur |  |  |
| `ui_092.csv` | ui | 499 | 15,761 | Machined Shield Backing[s] |  |  |
| `ui_093.csv` | ui | 495 | 21,066 | Maklain's Minstrel's Inscription[s] |  |  |
| `ui_094.csv` | ui | 500 | 17,970 | Maximum number of monuments already placed in |  |  |
| `ui_095.csv` | ui | 477 | 12,893 | Midnight Lotus Fishing Rod Skin now available |  |  |
...
| `ui_103.csv` | ui | 496 | 23,958 | of the Warrior |  |  |
| `ui_104.csv` | ui | 499 | 20,497 | One day, I hope to |  |  |
| `ui_105.csv` | ui | 498 | 21,364 | Orrian Pearl Strongbox[pl:"Strongboxes"] |  |  |
| `ui_106.csv` | ui | 498 | 21,756 | Paper that's hand-crafted can be identified w |  |  |
...
| `ui_116.csv` | ui | 496 | 16,121 | Recipe[s]: Chiaroscuro Hammers |  |  |
| `ui_117.csv` | ui | 500 | 15,889 | Recipe[s]: Gift of Music |  |  |
| `ui_118.csv` | ui | 499 | 15,713 | Recipe[s]: Lightborne Shield |  |  |
| `ui_119.csv` | ui | 500 | 15,708 | Recipe[s]: Raven Totem |  |  |
| `ui_120.csv` | ui | 498 | 14,708 | Recipe[s]: Stormcaller Greatsword |  |  |
| `ui_121.csv` | ui | 499 | 16,097 | Recipe[s]: Verata's Bastion |  |  |
| `ui_122.csv` | ui | 498 | 17,174 | Red Bean Cake[s] |  |  |
...
| `ui_130.csv` | ui | 499 | 17,339 | Shaman Gamli needs a plant called winter sage |  |  |
| `ui_131.csv` | ui | 499 | 19,348 | Shout to Sayida to steer her ship right. |  |  |
| `ui_132.csv` | ui | 499 | 14,014 | Siren Warhorn |  |  |
| `ui_133.csv` | ui | 497 | 19,666 | Slab[s] of the Solid Ocean |  |  |
| `ui_134.csv` | ui | 499 | 25,013 | Soldier's Backpack Strap |  |  |
| `ui_135.csv` | ui | 489 | 20,944 | Speak to Egan, Kasolov, or Koptev. |  |  |
| `ui_136.csv` | ui | 500 | 13,980 | Spire[s] of the Solid Ocean |  |  |
| `ui_137.csv` | ui | 498 | 18,208 | Stashed Harbinger Jewel[s] |  |  |
| `ui_138.csv` | ui | 500 | 21,462 | Strange activity has been reported in Diessa  |  |  |
| `ui_139.csv` | ui | 499 | 12,825 | Summon Choya |  |  |
