...
Всего батчей: **996** | строк: **468,969** | заполнено: **462,702** (98.7%), пусто **6,267** | вычитано человеком: **190,696** (40.7%).
...
| `skins_001.csv` | skins | 500 | 16,489 | <c=@flavor>"Caution: Contents extremely volat | ✅ | Arelion — 220 строк вычитано — названия обликов сведены к вычитанному корпусу (Aetherized к «эфирному», Rifle к «ружью» по глоссарию), серии оружия приведены к одной голове |
| `skins_002.csv` | skins | 500 | 10,330 | Beastslayer Scepter | ✅ | Arelion — 280 строк вычитано — серии сведены к одной голове (Beastslayer ×8 к «зверобою» вместо «убийцы зверей», «истребителя зверей» и «Зверобоя», Crimson Assassin к «Багровому ассасину», Collapsing Star к «Схлопывающейся звезде»), Reaver к «Жнецу» по глоссарию |
...
| `skins_004.csv` | skins | 500 | 9,018 | Etherbound Gauntlets | ✅ | Arelion — 254 строки вычитано — названия обликов взяты из вычитанного корпуса, серии приведены к одной голове |
| `skins_005.csv` | skins | 500 | 9,051 | Imperial Everbloom Pistol | ✅ | Arelion — 271 строка вычитана — названия обликов взяты из вычитанного корпуса, серии приведены к одной голове |
| `skins_006.csv` | skins | 500 | 9,402 | Mordremoth's Claw | ✅ | Arelion — 190 строк вычитано — названия обликов взяты из вычитанного корпуса, Warhorn к «боевому рогу», серии приведены к одной голове |
| `skins_007.csv` | skins | 500 | 10,248 | Researcher's Shoes | ✅ | Arelion — 226 строк вычитано — названия обликов взяты из вычитанного корпуса, серии приведены к одной голове |
